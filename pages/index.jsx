						...
						<div className="col-md-6 col-sm-12">
							<TitleAndDescription
								...
								description={[
									<ul key={1}>
										<li>
											<strong>Responsabilidad</strong>: Nos haremos responsables
											de mantener un ambiente de humildad y respeto.
										</li>

										<li>
											<strong>Puntualidad</strong>: Será lo más puntual posible
											para no tener retrasos con las horas planificadas.
										</li>

										<li>
											<strong>Atención</strong>: Nos mantendremos atentos con la
											atención al cliente para cualquier duda que se tenga sobre
											la empresa y de cómo trabajamos.{" "}
										</li>

										<li>
											<strong>Comodidad</strong>: Haremos lo posible para
											mantener cómodos a todas las personas durante los viajes
											con las diferentes empresas.{" "}
										</li>

										<li>
											<strong>Honestidad</strong>: Se tratará a las personas con
											la mayor honestidad posible, amabilidad,y con una buena
											atención.{" "}
										</li>
										<li>
										...
										<li>
											...
											constante con las diferentes personas que nos contraten,
											para así tener un ambiente de confianza. Presentación: Se
											presentará la empresa de distintas maneras para lograr
											tener la atención de las personas.
										</li>
									</ul>,
								]}
							/>
